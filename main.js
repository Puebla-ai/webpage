      ...
      .then(res => {
        ...
        if (res.ok) {
          ...
          alert(currentLang === 'es'
            ? 'Hubo un error al enviar. Escríbenos a hola@pueblai.com'
            : 'There was an error. Please email us at hola@pueblai.com');
        }
      })
      .catch(() => {
        btn.disabled = false;
        btn.textContent = originalText;
        alert(currentLang === 'es'
          ? 'Sin conexión. Escríbenos a hola@pueblai.com'
          : 'No connection. Please email us at hola@pueblai.com');
      });
    });
